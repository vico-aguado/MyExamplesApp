...
class PropertiesSelector extends StatefulWidget {
  PropertiesSelector({
    this.title,
    this.values,
    this.disabled = false,
  ...
  @override
  State<StatefulWidget> createState() => PropertiesSelectorState();
}

class PropertiesSelectorState extends State<PropertiesSelector> {
  int valueIndex = 0;
          ...
          children: <Widget>[
            ...
            Text(
              ...
              style: TextStyle(
                ...
                color: widget.disabled ? Colors.black26 : Colors.white,
              ),
            ),
            IconButton(
              color: Colors.white,
